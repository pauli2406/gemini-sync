...
IngestRelay is a GitOps-managed ingestion runtime that normalizes source records, computes reconciliation deltas, publishes artifacts, and ingests into Discovery Engine.
